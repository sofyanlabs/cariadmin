...
const TestimonialHome = () => (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mx-auto md:px-20 lg:px-0">
            <div 
            className="bg-blue-50 rounded-3xl p-6 divide-y divide-blue-600"
            data-sal="slide-up"
            data-sal-duration="1000"
            data-sal-delay="200"
            >
            ...
            <div 
            className="bg-blue-200 rounded-3xl p-6 divide-y divide-blue-600 shadow-2xl shadow-blue-200"
            data-sal="slide-up"
            data-sal-duration="1000"
            data-sal-delay="400"
            >
