...
const Desain = () => (
  <Layout>
    <Seo title="Jasa Admin Pembuatan Desain Grafis / Logo &amp; Branding Produk"/>
    ...
    <section className="bg-gradient-to-br md:bg-gradient-to-r from-blue-800 to-blue-500">
        ...
        className="py-16 px-4 text-center">
            <div className="text-white space-y-6">
                <h1 className="text-2xl md:text-4xl font-medium">Jasa Admin Sosial Media</h1>
                <p className="text-base md:text-lg">Jasa pengelolaan sosial media secara profesional untuk meningkatkan pengenalan usaha hingga minat dan jangkauan pembeli.</p>
                ...
                <nav className="flex justify-center" aria-label="Breadcrumb">
                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <div className="flex items-center">
                            <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"></path></svg>
                            <span className="ml-1 text-sm font-medium text-gray-200 md:ml-2">Sosial Media</span>
                        </div>
                        </li>
                    </ol>
                </nav>
