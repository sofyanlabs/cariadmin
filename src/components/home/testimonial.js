...
const TestimonialHome = () => (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mx-auto md:px-20 lg:px-0">
            <div className="bg-blue-50 rounded-3xl p-6 divide-y-2 divide-blue-200">
                ...
                <div className="pt-4">
                    <p className="text-gray-600">
                        "Pertama kali bangun bisnis secara online, dibantu sekali dengan adanya Cariadmin. Peningkatan pelanggan sangat terasa setelah dikelola oleh admin dari Cariadmin."
                    </p>
                </div>
            </div>
            <div className="bg-blue-200 rounded-3xl p-6 divide-y-2 divide-blue-300 shadow-2xl shadow-blue-200">
                <div className="flex items-center justify-between pb-4">
                    <div className="flex items-center">
                    <StaticImage 
                    src="../../images/adinda.png"
                ...
                <div className="pt-4">
                    <p className="text-gray-600">
                        "Senang sekali bisa konsultasi dan bekerjasama dengan Cariadmin. Membantu bisnis kami berkembang pesat di dunia digital."
                    </p>
                </div>
            </div>
            <div className="bg-blue-50 rounded-3xl p-6 divide-y-2 divide-blue-200">
                ...
                <div className="pt-4">
                    <p className="text-gray-600">
                        "Pesan desain logo disini, desain yang diberikan oleh adminnya bagus banget. Hasilnya sesuai dengan yang aku inginkan. Thankyou Cariadmin!"
                    </p>
                </div>
            </div>
        </div>
